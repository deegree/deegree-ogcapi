...
The https://ogcapi-workshop.ogc.org/[OGC API workshop] provides more information about the new standards and explains the basic concepts.
...
* https://docs.ogc.org/is/19-079r2/19-079r2.html[OGC API - Features - Part 3: Filtering] (Partly) with support for several https://docs.ogc.org/is/21-065r2/21-065r2.html[CQL2] functions.
...
=== dataset
Is a collection of data. In the context of deegree ogcapi a dataset is the set of feature types provided by a feature store. It is identified by its _{datasetId}_.
...
=== feature
Is an abstraction of real world phenomena. In the context of deegree ogcapi it is a spatial entity stored in a datasource. It is identified by its _{featureId}_.

=== feature collection
Is a set of features from a dataset. It is identified by its _{collectionId}_.
