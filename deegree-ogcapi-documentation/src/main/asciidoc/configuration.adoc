...
<deegreeServicesMetadata xmlns="http://www.deegree.org/services/metadata"
  ...
  <DatasetMetadata>
    ...
    <Dataset>
      <Name xmlns:app="http://www.deegree.org/app">app:streets</Name> <!--5-->
      <Title>Streets</Title> <!--6-->
...
<5> feature collection name which links to the feature type configured, here the {collectionId}
<6> title of the feature collection, used in HTML encoding instead of the {collectionId}
