...
public final class OgcApiFeaturesMediaType {
	...
	public static final MediaType APPLICATION_OPENAPI_TYPE = new MediaType("application",
	...
	public static final MediaType APPLICATION_OPENAPI_YAML_TYPE = new MediaType("application",
			"vnd.oai.openapi+yaml;version=3.0");
