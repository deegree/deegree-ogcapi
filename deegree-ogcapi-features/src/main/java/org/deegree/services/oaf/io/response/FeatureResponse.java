...
public class FeatureResponse extends AbstractFeatureResponse {
    ...
    private final FeatureInputStream feature;

    FeatureResponse( FeatureInputStream feature,
                     Map<String, String> featureTypeNsPrefixes, List<Link> links,
                     String responseCrsName, SchemaLocation schemaLocation ) {
        super( featureTypeNsPrefixes, responseCrsName, schemaLocation, links );
        this.feature = feature;
    }

    public FeatureInputStream getFeature() {
        return feature;
    }
