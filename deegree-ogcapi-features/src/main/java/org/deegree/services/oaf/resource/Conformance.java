...
public class Conformance {
	...
	@Operation(operationId = "conformance", summary = "supported conformance classes",
			description = "Retrieves the supported conformance classes")
	@Tag(name = "Capabilities")
	@ApiResponse(description = "default response", content = @Content(
			schema = @Schema(implementation = org.deegree.services.oaf.domain.conformance.Conformance.class)))
	...
	private Response conformance(String formatParamValue, RequestFormat defaultFormat) throws InvalidParameterValue {
