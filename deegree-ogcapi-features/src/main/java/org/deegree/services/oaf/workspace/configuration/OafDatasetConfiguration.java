...
public class OafDatasetConfiguration {
	...
	/**
	 * @return the {@link FeatureTypeMetadata} off all feature types (OAF collections)
	 * provided by this OAF dataset.
	 */
	...
	/**
	 * @param collectionId must not be <code>null</code>
	 * @return the {@link FeatureTypeMetadata} of the feature type (OAF collection) with
	 * the passed name, may be <code>null</code>
	 * @throws UnknownCollectionId if the collection is not available
	 */
	public FeatureTypeMetadata getFeatureTypeMetadata(String collectionId) throws UnknownCollectionId {
	...
	/**
	 * Checks if a collection with the passed collection id is available by this
	 * configuration.
	 * @param collectionId the id of the collection
	 * @throws UnknownCollectionId if the collection is not available
	 */
	public void checkCollection(String collectionId) throws UnknownCollectionId {
	...
	/**
	 * @return <code>true</code> if the existing GML applicationschema should be returned
	 * (if exists), <code>false</code> if the schema should be (re)generated.
	 */
	...
	public String toString() {
		return "OafDatasetConfiguration{" + "id='" + id + '\'' + ", featureTypeMetadata=" + featureTypeMetadata
				+ ", serviceMetadata=" + serviceMetadata + ", suppportedCrs=" + suppportedCrs
