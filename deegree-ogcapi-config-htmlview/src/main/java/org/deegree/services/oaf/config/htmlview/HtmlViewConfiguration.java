...
public class HtmlViewConfiguration {
	...
	/**
	 * @param cssFile must be an file and must exist, may be <code>null</code>
	 * @param legalNoticeUrl the URL to retrieve the legalNotice, may be <code>null</code>
	 * @param privacyUrl the URL to retrieve the privacy, may be <code>null</code>
	 * @param documentationUrl the URL to retrieve the documentation, may be
	 * <code>null</code>
	 * @param wmsUrl the URL of the WMS, may be <code>null</code>
	 * @param wmsVersion the WMS Version to use, may be <code>null</code>
	 * @param wmsLayers the layers of the WMS, may be <code>null</code>
	 * @param crsCode the crs code of the map, may be <code>null</code>
	 * @param crsProj4Definition the proj4 definition of the crs of the map, may be
	 * <code>null</code>
	 * @param source source of the map, may be <code>null</code>
	 */
	...
	/**
	 * @return the configured cssFile, must be an file and must exist, may be
	 * <code>null</code>
	 */
	...
	/**
	 * @return ths layers (comma separated) provided by the WMS, may be <code>null</code>
	 * if wmsUrl is <code>null</code>
	 */
	...
	public String toString() {
		return "HtmlViewConfiguration{" + "cssFile=" + cssFile + ", legalNoticeUrl='" + legalNoticeUrl + '\''
				+ ", privacyUrl='" + privacyUrl + '\'' + ", documentationUrl='" + documentationUrl + '\'' + ", wmsUrl='"
				+ wmsUrl + '\'' + ", wmsVersion='" + wmsVersion + '\'' + ", wmsLayers='" + wmsLayers + '\''
				+ ", crsCode='" + crsCode + '\'' + ", crsProj4Definition='" + crsProj4Definition + '\'' + ", source='"
				+ source + '\'' + '}';
	}
